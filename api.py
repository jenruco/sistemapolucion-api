    ...
    def do_POST(self):
        if re.search('/ingresa', self.path):
            ...
            try:
                ...
                cursor.execute("INSERT INTO data_calidad (monoxido_carbono, humedad, temperatura, dioxido_carbono, presion_admosferica, gas_propano) VALUES (%s,%s,%s,%s,%s,%s)", (monoxido_carbono, humedad, temperatura, dioxido_carbono, altitud_mar, gas_propano))
                print(fe_creacion)
                conn.commit()
